        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div class="space-y-8">
                    ...
                    <div class="space-y-6">
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-500 text-sm">
                                    [Shop Address Here]<br>
                                    [City, Uttar Pradesh, Zip Code]
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-500 text-sm">6386517300, 9956510247</p>
                                <p class="text-gray-500 text-sm">7007465665</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-500 text-sm">Dr. Praveen Joshi</p>
                            </div>
                        </div>
                    </div>
                ...
                <div
                    ...
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3559.877284414614!2d80.946165!3d26.846694!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjbCsDUwJzQ4LjEiTiA4MMKwNTYnNDYuMiJF!5e0!3m2!1sen!2sin!4v1630000000000!5m2!1sen!2sin"
                ...
                <form action="#" class="space-y-5">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div class="space-y-2">
                            ...
                            <input type="text" placeholder="Enter your name"
                                class="w-full bg-gray-50 border-none rounded-xl px-5 py-4 focus:ring-2 focus:ring-yellow-500 transition-all">
                        </div>
                        <div class="space-y-2">
                    ...
                    <div class="space-y-2">
                        <label class="text-[10px] font-bold uppercase text-gray-400 tracking-widest">Inquiry
                            Type</label>
                        <select
                            class="w-full bg-gray-50 border-none rounded-xl px-5 py-4 focus:ring-2 focus:ring-yellow-500 transition-all text-gray-500">
                            <option>Retail Purchase</option>
                            <option>Wholesale Order</option>
                            <option>Project Supply</option>
                            <option>Product Availability Check</option>
                            <option>Other</option>
                        </select>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea rows="4" placeholder="How can we help you today?"
                            class="w-full bg-gray-50 border-none rounded-xl px-5 py-4 focus:ring-2 focus:ring-yellow-500 transition-all"></textarea>
                    </div>
