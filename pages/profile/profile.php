...
<!-- Tailwind and Font Awesome already loaded in header.php -->
        ...
        <div class="w-full lg:w-1/3 space-y-6">
            <div class="nav-card text-center">
                <div class="relative inline-block mb-6">
                    ...
                    <div
                        class="absolute -bottom-2 -right-2 w-8 h-8 bg-slate-900 text-white rounded-xl flex items-center justify-center text-xs shadow-lg">
                ...
                <span
                    class="px-4 py-1.5 bg-orange-50 text-orange-600 rounded-full text-[9px] font-black uppercase tracking-widest border border-orange-100">
            ...
            <div class="nav-card">
                <div class="flex flex-col gap-2">
                    <button onclick="window.location.href='?tab=personal'"
                        class="nav-item <?php echo $active_tab == 'personal' ? 'nav-item-active' : 'nav-item-inactive'; ?>">
                        <i class="fas fa-user-circle w-5"></i> Personal Info
                    </button>
                    <button onclick="window.location.href='?tab=security'"
                        class="nav-item <?php echo $active_tab == 'security' ? 'nav-item-active' : 'nav-item-inactive'; ?>">
        ...
        <div class="w-full lg:w-2/3">
            ...
            <?php if ($active_tab == 'personal'): ?>
                <div class="content-card animate-fadeIn">
                    <h3 class="text-xl font-extrabold tracking-tight mb-10 border-b border-slate-50 pb-6">Account
                        Synchronization</h3>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="address" rows="3"
                                    class="input-premium resize-none"><?php echo htmlspecialchars($user['address']); ?></textarea>
                            </div>
                            <div>
                    ...
                    <form action="?tab=security" method="POST" class="space-y-8 max-w-xl">
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <input type="password" name="new_password" required class="input-premium"
                        ...
                        <div class="pt-6">
                            <button type="submit" name="change_password" class="btn-sync w-full md:w-auto">Update Access
                                Keys</button>
                        </div>
                    </form>
                </div>
