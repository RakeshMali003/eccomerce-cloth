...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $params = [
        'sid'     => $_POST['preferred_supplier_id'],
        'cid'     => $_POST['category_id'],
        'psid'    => $_POST['preferred_supplier_id'],
        'name'    => $_POST['name'],
        'sku'     => $_POST['sku'],
        'desc'    => $_POST['description'],
        'price'   => $_POST['price'],
        'w_price' => $_POST['wholesale_price'],
        'w_qty'   => $_POST['min_wholesale_qty'] ?? 1,
        'gst'     => $_POST['gst_percent'] ?? 0,
        'disc'    => $_POST['discount_percent'] ?? 0,
        'stock'   => $_POST['stock'],
        'min_s'   => $_POST['min_stock_level'],
    ...
    try {
        if ($action === 'edit') {
            ...
            if ($main_img) { $sql .= ", main_image = :m_img"; $params['m_img'] = $main_img; }
            if ($img1) { $sql .= ", image_1 = :i1"; $params['i1'] = $img1; }
            if ($img2) { $sql .= ", image_2 = :i2"; $params['i2'] = $img2; }
            if ($img3) { $sql .= ", image_3 = :i3"; $params['i3'] = $img3; }
            if ($img4) { $sql .= ", image_4 = :i4"; $params['i4'] = $img4; }
