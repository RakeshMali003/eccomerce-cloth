...
<head>
    ...
    <title>Gurukrupa Admin | Secure Gateway</title>
    <style>
    ...
    <div class="w-full max-w-md relative z-10 animate-float">
        ...
        <div class="text-center mb-10">
            <h1 class="text-white text-5xl font-extrabold tracking-tighter uppercase italic">
                Gurukrupa<span class="text-orange-600">.</span>
            </h1>
        ...
        <div class="glass-panel rounded-[3rem] p-10 shadow-2xl">
            ...
            <?php if($error): ?>
                <div class="mb-6 p-4 bg-red-500/10 text-red-400 rounded-2xl text-[10px] font-black uppercase text-center border border-red-500/20">
            ...
            <form action="" method="POST" class="space-y-6">
                <div class="space-y-2">
                    <label class="text-[9px] font-black uppercase text-slate-500 ml-1 tracking-widest">Master Identifier</label>
                    <div class="relative">
                        <input type="email" name="email" required placeholder="admin@gurukrupa.com"
                ...
                <div class="space-y-2">
                    <label class="text-[9px] font-black uppercase text-slate-500 ml-1 tracking-widest">Access Protocol</label>
                    <div class="relative">
                ...
                <div class="pt-4">
                    <button type="submit" class="w-full bg-orange-600 text-white py-5 rounded-2xl font-black uppercase text-[10px] tracking-[0.25em] shadow-lg shadow-orange-900/40 hover:bg-orange-500 hover:scale-[1.02] transition-all active:scale-95">
                        Initialize Session
                    </button>
                </div>
            </form>
        ...
        <p class="text-center text-slate-600 text-[10px] mt-8 font-medium">
            &copy; 2025 Gurukrupa Textiles. System Version 4.0.2
        </p>
    </div>
